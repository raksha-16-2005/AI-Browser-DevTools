    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-gray-50 p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-gradient-to-br from-green-600 to-green-700 mb-4 text-4xl">
            ⚡
          </div>
              ...
              logs.map((log) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex-shrink-0 p-2 rounded hover:bg-gray-700/50 transition-colors text-gray-500 hover:text-gray-300 text-xl"
